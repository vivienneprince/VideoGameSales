...
```{r}
videogames.clean <- videogames.clean[which(videogames.clean$Global_Sales > 17), ] 
```
...
#Mean does not fall into 95% confidence interval so we reject Null Hypothesis. However, due to the sample not being randomized, we should opt to use bootstrapping instead.
