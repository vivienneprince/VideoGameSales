...
Here we conducted a t test with 95% confidence interval looking at sales for the Action Genre. We ignored any NA values. We can see that the confidence intervals for Action game sales are much higher than the confidence intervals for the video game sales of the entire dataset thus rejecting the null hypothesis.
```{r}
...
#Null Hypothesis would be that confidence intervals are equal


t.test(videogames.clean$Global_Sales, conf.level = 0.95)$conf.int

#0.3552499 0.3787933

#Not Equal so we reject Null Hypothesis
